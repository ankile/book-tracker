...
//
//   node migrate-authors.js                    # emulator dry-run
//   node migrate-authors.js --apply            # emulator apply
//   node migrate-authors.js --prod             # prod dry-run
//   node migrate-authors.js --prod --apply     # prod apply (typed confirm)
import { Timestamp } from 'firebase-admin/firestore';
import { parseFlags, connect, batcher } from './migrate-lib.js';
import { splitAuthors, joinAuthors, authorIdFor } from './src/lib/utils/authors.js';
