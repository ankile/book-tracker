...
test("finishedAtByBook maps finished books to their last update", () => {
  ...
  assert.equal(finishedAt.get("a").getTime(), new Date("2026-01-08T09:00:00").getTime());
...
test("dustyShelf ranks unfinished books by staleness", () => {
  ...
  const books = [
    { id: "b", finished: false, title: "Beta", currentPage: 50, pageCount: 200 },
