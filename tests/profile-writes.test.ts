...
test('client caps mirror the rules literals for books', async () => {
  ...
  assert.deepEqual(
    ...
    // lastReadAt is typed null-or-timestamp by validBookLastReadAt.
    ['activeTimer', 'currentPage', 'currentPageUpdateId', 'finished', 'finishedAt', 'lastReadAt', 'pagesRead', 'timeRead', 'updatedAt'],
  );
