...
- Disposable test accounts, projects and books only. Load the actual default-database Rules into the emulator; the CLI's multi-database configuration may otherwise warn that it is using permissive rules.
