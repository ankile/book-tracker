...
const rows: AccessRow[] = [
  ...
  {
    name: 'Catalog console',
    path: '/admin',
    reached: ['Direct URL only'],
    read: ['Authorized operator', 'Live data permissions'],
    readKind: 'privileged',
    writes: ['New authors · Works · Editions', 'Merges and personal-book links'],
    writeKind: 'privileged',
  },
  {
    name: 'Catalog work page',
    path: '/admin/works/[workId]',
    reached: ['Catalog console work row', 'Author page work row · direct URL'],
    read: ['Authorized operator', 'Live data permissions'],
    readKind: 'privileged',
    writes: ['This Work and its Editions', 'Its readers\' catalog links'],
    writeKind: 'privileged',
  },
  {
    name: 'Catalog author page',
    path: '/admin/authors/[authorId]',
    reached: ['Catalog console author row', 'Work page author link · direct URL'],
    read: ['Authorized operator', 'Live data permissions'],
    readKind: 'privileged',
    writes: ['This author · merges into another', 'Nothing else on this page'],
    writeKind: 'privileged',
  },
  {
    name: 'Accounts and issues',
    path: '/admin/users',
    reached: ['Catalog console · direct URL'],
